					...
					<div class="pull-left">
						<div class="form-group form-inline">
							...
							<select class="form-control" id="changePageSize" onchange="changePageSize()">
								<c:forEach begin="50" step="50" end="300" varStatus="bit">
									<c:choose>
										<c:when test="${bit.count * 50 == syslogSize}">
											<option selected="selected">${bit.count * 50}</option>
										</c:when>
										<c:otherwise>
											<option>${bit.count * 50}</option>
										</c:otherwise>
									</c:choose>

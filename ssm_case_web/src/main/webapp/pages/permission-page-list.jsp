									...
									<c:forEach items="${pageInfo.list}" var="p">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/permission/deletePermissionById.do?id=${p.id}" class="btn bg-olive btn-xs">删除权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
							...
							<div class="form-group form-inline">
								...
								<select class="form-control" id="changePageSize" onchange="changePageSize()">
									...
									<c:forEach begin="1" step="1" end="5" varStatus="bit">
										<c:choose>
											<c:when test="${bit.count == permissionSize}">

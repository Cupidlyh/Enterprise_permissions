			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-10 data rowHeight2x">
						<textarea class="form-control" rows="3" placeholder="其他信息" readonly="readonly">${orders.orderDesc }
						</textarea>
					</div>
					...
					<tbody>
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								...
								<td><input type="text" size="1" value="${traveller.sex }"
									readonly="readonly"></td>
								...
								<td><input type="text" size="6"
										   value="${orders.payTypeStr }" readonly="readonly"></td>
								<td><input type="text" size="23"
										   value="${orders.product.productPrice }" readonly="readonly"></td>
								<td><button type="button" class="btn bg-olive btn-xs">删除</button></td>
							</tr>
						</c:forEach>

									...
									<c:forEach items="${pageInfo.list}" var="product">
										...
										<tr>
											...
											<td class="text-center">
												...
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/product/findByIdAndAlter.do?id=${product.id}'">编辑</button>
							...
							<div class="form-group form-inline">
								...
								<select class="form-control" id="changePageSize" onchange="changePageSize()">
									<c:forEach begin="1" step="1" end="5" varStatus="bit">
										<c:choose>
											<c:when test="${bit.count == productSize}">
